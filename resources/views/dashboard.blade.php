  ...
  <main id="main">
            ...
            <div class="row gy-5">
              ...
              @foreach($menu as $data)
                <div class="col-lg-4 menu-item">
                  <a href="{{ asset('storage/images/'.$data->gambar) }}" class="glightbox"><img src="{{ asset('storage/images/'.$data->gambar) }}" class="menu-img img-fluid w-100 h-75" alt=""></a>
                  <h4>{{ $data->nama }}</h4>
                  <p class="ingredients">
                    {{ $data->jenis }}
                  </p>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="chef-member">
              <div class="member-img">
                <img src="{{ asset('storage/images/'.$data->gambar) }}" class="img-fluid" alt="">
                <div class="social">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-8 d-flex align-items-center reservation-form-bg">
            <form action="{{ route('booking') }}" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
              @csrf
              <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6">
                  <input type="text" class="form-control" name="nohp" id="phone" placeholder="Your Phone" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
                  <div class="validate"></div>
                </div>
                <div class="col-lg-4 col-md-6">
                  <input type="date" name="tanggal" class="form-control" id="date" placeholder="Date" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
                  <div class="validate"></div>
                </div>
                <div class="col-lg-4 col-md-6">
                  <input type="time" class="form-control" name="waktu" id="time" placeholder="Time" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
                  <div class="validate"></div>
                </div>
                <div class="col-lg-4 col-md-6">
              ...
              <div class="text-center my-4"><button type="submit">Book a Table</button></div>
                @if(Session::has("success"))
                <div class="alert alert-success text-center">
                  <p>Booking success and wait admin confirmed!</p>
                </div>
                @endif
            </form>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="mb-3">
          <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.2494140439476!2d110.74605877485406!3d-7.547757874517339!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a148d8d70b9d9%3A0xc1e245d411c6ff6a!2sSTMIK%20AMIKOM%20Surakarta!5e0!3m2!1sid!2sid!4v1707502150773!5m2!1sid!2sid" frameborder="0" allowfullscreen ></iframe>
        </div><!-- End Google Maps -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-md-6">
            <div class="info-item  d-flex align-items-center">
              ...
              <div>
                <h3>Our Address</h3>
                <p>Jl. Veteran, Dusun I, Singopuran, Kec. Kartasura, Kabupaten Sukoharjo, Jawa Tengah 57163</p>
              </div>
            </div>
          </div><!-- End Info Item -->
        ...
        <form action="{{ route('message_proc') }}" method="post" class="php-email-form p-3 p-md-4">
          @csrf
          <div class="row">
              @if(Session::has("success_m"))
                <div class="alert alert-success text-center text-success">
                  <p>Message was success sent!</p>
                </div>
                @endif
      ...
      <div class="row gy-3">
        ...
        <div class="col-lg-3 col-md-6 footer-links d-flex">
          ...
          <div>
            <h4>Reservations</h4>
            <p>
              <strong>Phone:</strong> +62 8992 0120 1232<br>
              <strong>Email:</strong> yummy@example.com<br>
            </p>
          </div>
        </div>
