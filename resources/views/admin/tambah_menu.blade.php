    ...
    <section class="section dashboard">
      ...
      <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" enctype="multipart/form-data" method="post" action="{{ route('menu.store') }}">
                @csrf
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="inputName6" name="jenis">
                </div>
                <div class="col-md-12">
                  <label for="inputName7" class="form-label">Harga</label>
                  <input type="text" class="form-control" id="inputName7" name="harga">
                </div>
