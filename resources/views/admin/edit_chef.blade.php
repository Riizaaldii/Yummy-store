    ...
    <section class="section dashboard">
      ...
      <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" enctype="multipart/form-data" method="post" action="{{ route('chef.update', $data->id ) }}">
                @csrf
                @method('PUT')
                
                <div class="col-md-12">
                  <label for="inputName5" class="form-label">Nama Menu</label>
                  <input type="text" class="form-control" id="inputName5" name="nama" value="{{ $data->nama }}">
                </div>
                <div class="col-md-6">
                  <label for="inputEmail5" class="form-label">Gambar</label>
                  <input type="file" class="form-control" id="inputEmail5" name="gambar">
                  <img src="{{ asset('storage/images/'.$data->gambar) }}" style="height: 70px; width:100px;" class="mt-1">
                </div>
                <div class="col-md-6">
                  <label for="inputName6" class="form-label">Posisi</label>
                  <input type="text" class="form-control" id="inputName6" name="posisi" value="{{ $data->posisi }}">
                </div>
                <div class="col-md-12">
                  <label for="inputName7" class="form-label">Quote</label>
                  <input type="text" class="form-control" id="inputName7" name="quote" value="{{ $data->quote }}">
                </div>
