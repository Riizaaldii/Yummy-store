...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambah Data Chef</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      ...
      <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tambah Chef</h5>

              <!-- Multi Columns Form -->
              <form class="row g-3" enctype="multipart/form-data" method="post" action="{{ route('chef.store') }}">
                @csrf
                <div class="col-md-12">
                  <label for="inputName5" class="form-label">Nama Chef</label>
                ...
                <div class="col-md-6">
                  <label for="inputName6" class="form-label">Posisi Chef</label>
                  <input type="text" class="form-control" id="inputName6" name="posisi">
                </div>
                <div class="col-md-12">
                  <label for="inputName7" class="form-label">Quote</label>
                  <input type="text" class="form-control" id="inputName7" name="quote">
                </div>
