...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Data Chef</h5>
    ...
    <table class="table datatable">
      ...
      <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('chef.edit', $user->id) }}" class="btn btn-sm btn-primary">EDIT</a> ||  
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('chef.destroy', $user->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
